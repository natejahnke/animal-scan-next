  ...
  return (
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <h3 className="text-center text-gray-700">
        Upload an image of an animal to find out its name with Nate's AI Animal
        Detector
      </h3>
      <AnimalImage onImageProcess={handleImageProcess} onImageUpload={handleImageUpload}
          onLoadingComplete={handleLoadingComplete} setLoading={setLoading} />
      {loading ? (
